...
export class ProductAttributeRepository {
    ...
    async create(data: Partial<ProductAttributeEntity>): Promise<ProductAttributeEntity> {
        return this.repository.save(this.repository.create(data));
    }

    async findByClassificationId(classificationId: number): Promise<ProductAttributeEntity[]> {
        return await this.repository.find({
            where: { product_classification_id: classificationId, deleted_at: IsNull() },
        });
    }
    ...
    async createMany(data: Partial<ProductAttributeEntity>[]): Promise<ProductAttributeEntity[]> {
    ...
    async update(id: number, data: Partial<ProductAttributeEntity>): Promise<void> {
