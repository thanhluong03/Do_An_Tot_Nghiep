...
export class SeedSuperAdminUser1757434387095 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (!Array.isArray(existingUser) || existingUser.length === 0) {
            await queryRunner.query(
                `INSERT INTO public.users
                 (role_id, username, password_hash, email, full_name, phone_number, address, is_active, created_at)
        ...
        console.log('✅ Seed SUPER_ADMIN and admin user created successfully.');
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        console.log('🧹 SUPER_ADMIN and admin user removed.');
    }
}
