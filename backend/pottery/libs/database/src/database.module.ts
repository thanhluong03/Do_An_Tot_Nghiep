...
import { ProductEntity, ProductImageEntity, SupplierEntity, RoleEntity, PermissionEntity, StoreEntity, UserEntity, ReviewEntity, PromotionEntity, ProductPromotionEntity, VoucherEntity, VoucherCustomerEntity, CustomerEntity, OrderEntity, OrderItemEntity, InventoryEntity, NewsEntity, CartItemEntity, CategoryEntity, PaymentTransactionEntity, ImportProductEntity } from './entities';
...
const postgresEntities = [ProductEntity, ProductImageEntity, SupplierEntity, RoleEntity, PermissionEntity, StoreEntity, UserEntity, ReviewEntity, PromotionEntity, ProductPromotionEntity, VoucherEntity, VoucherCustomerEntity, CustomerEntity, OrderEntity, OrderItemEntity, InventoryEntity, NewsEntity, CartItemEntity, CategoryEntity, PaymentTransactionEntity, ImportProductEntity];
@Module({
  imports: [
