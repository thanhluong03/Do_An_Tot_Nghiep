            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    {valueItems.map((item, index) => (
                        <div key={index} className="bg-white rounded-xl shadow-lg p-0 flex flex-col items-center border border-[#F5F1EB]">
                            
                            {/* Khối Hình Ảnh */}
                            <div className="w-full aspect-video rounded-t-xl overflow-hidden shadow-sm">
                                <img 
                                    src={item.image} 
                                    alt={item.alt} 
                ...
                {/* Statistics Box */}
                <div className="max-w-8xl mx-auto bg-white rounded-xl shadow-2xl p-8 border border-[#F5F1EB]">
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
                        {statItems.map((stat, index) => (
                            <div key={index} className="text-center">
                                <div className="text-4xl font-bold text-[#65604E] mb-1">{stat.value}</div>
                                <div className="text-base text-[#2C2A24]">{stat.label}</div>
                            </div>
                        ))}
                    </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                  {testimonialsData.map((item, index) => (
                      ...
                      <div key={index} className="bg-white rounded-xl shadow-md p-6 flex flex-col border border-gray-100">
              ...
              {/* Statistics Block */}
              <div className="max-w-8xl mx-auto mt-16 bg-white rounded-xl shadow-md border border-gray-100 p-8">
                  <div className="grid grid-cols-4 gap-8">
                      {statsReviewData.map((stat, index) => (
                          <div key={index} className="flex flex-col items-center">
                              {/* Số liệu */}
                              <span className="text-5xl font-bold text-[#2C2A24] mb-2">
                                  {stat.value}
                              </span>
                              {/* Mô tả */}
                              <span className="text-base text-[#65604E] text-center mb-2">
                                  {stat.label}
                              </span>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {featuredPosts.map((post, index) => (
                ...
                <div key={index} className="bg-white rounded-xl overflow-hidden border border-gray-100 flex flex-col">
                    
                    {/* Image with Tag Overlay */}
                    <div className="relative w-full aspect-[100/99]">
                        <img 
                            src={post.image} 
                            alt={post.title} 
                            className="w-full h-full object-cover" 
