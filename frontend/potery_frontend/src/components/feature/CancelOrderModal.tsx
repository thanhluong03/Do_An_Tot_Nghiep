                            ...
                            {images.length < 5 && (
                                ...
                                <div className="flex items-center">
                                    ...
                                    <label
                                        ...
                                        htmlFor="image-upload-cancel"

                                        className="border-2 border-dashed border-[#C4975A] rounded-xl px-3 py-2 text-center cursor-pointer hover:bg-[#a97e4a] transition-colors flex flex-col items-center gap-1 bg-gray-50"
