...
export default function NewsPage() {
  ...
  return (
    <BaseLayout>
      ...
      <div className="relative w-screen left-1/2 right-1/2 -mx-[50vw] -mt-[100px] md:-mt-[120px]">
        <img
          src="/bg-new.jpg"
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center bg-black/30 text-white text-center px-4">
          ...
          <p className="text-lg md:text-xs">
            Cập nhật về gốm, cảm hứng sáng tạo, và hoạt động từ Tiệm Gốm Nhà Gạo
          </p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {items.map((n) => (
                ...
                >
                  ...
                  <h2 className="text-lg font-semibold text-[#2C2A24] line-clamp-2">
                    {n.title}
                  </h2>
                  ...
                  <div className="mt-auto pt-4">
                    <a
                      href="#"
                      className="inline-block text-[#65604E] hover:underline"
                    >
                      Đọc tiếp
                    </a>
                  </div>
